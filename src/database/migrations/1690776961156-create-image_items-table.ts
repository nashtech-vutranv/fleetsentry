...
export class CreateImageItemsTable1690776961156 implements MigrationInterface {
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: "image_size", type: "varchar", length: "20" },
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.dropTable("image_items");
  }
}
